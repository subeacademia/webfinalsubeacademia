...
@Component({
  selector: 'app-certification-wizard-simple',
  standalone: true,
...
export class CertificationWizardSimpleComponent implements OnInit {
  ...
  ngOnInit(): void {
    console.log('CertificationWizardSimpleComponent initialized');
  ...
  private mapFormToCertification(formData: any): Omit<Certificacion, 'id'> {
    return {
      ...
      state: 'Disponible' as CertificationState,
      active: true,
      versionPlan: '2025.1',
