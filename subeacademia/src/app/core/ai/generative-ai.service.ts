  ...
  private buildGeminiPrompt(diagnosticData: DiagnosticoFormValue, scores: DiagnosticoScores, formattedCoursesString: string): string {
    ...
    return `
      ...
      **Resultados del Diagnóstico:**
      ...
      - Puntajes de Competencias (las más bajas son las debilidades principales): ${JSON.stringify(scores.competencias)}
      ...
      **Tu Tarea:**
      Genera un objeto JSON con la siguiente estructura exacta:
      {
        ...
        "analisis_ares": [
          { "dimension": "Agilidad", "puntaje": ${scores.ares.promedio || 0}, "analisis": "Un análisis breve y experto sobre lo que significa este puntaje en la dimensión 'Agilidad' para la organización." },
          { "dimension": "Responsabilidad", "puntaje": ${scores.ares.promedio || 0}, "analisis": "Análisis similar para 'Responsabilidad'." },
          { "dimension": "Ética", "puntaje": ${scores.ares.promedio || 0}, "analisis": "Análisis similar para 'Ética'." },
          { "dimension": "Sostenibilidad", "puntaje": ${scores.ares.promedio || 0}, "analisis": "Análisis similar para 'Sostenibilidad'." }
        ],
        "plan_de_accion": [
          {
