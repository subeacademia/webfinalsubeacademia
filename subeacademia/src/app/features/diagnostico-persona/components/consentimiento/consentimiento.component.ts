  ...
  template: `
    <div class="max-w-3xl mx-auto">
      ...
      <form [formGroup]="consentForm" (ngSubmit)="onSubmit()" class="space-y-6">
        ...
        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 text-sm leading-relaxed">
        ...
        <div class="space-y-4">
          ...
          <div class="flex items-start space-x-3">
            ...
            />
            <label for="acepto" class="text-sm text-gray-700 dark:text-gray-300">
              <span *ngIf="!isMenor">
          ...
          <div *ngIf="isMenor" class="space-y-2">
            <label for="tutor" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
          ...
          <div *ngIf="isMenor" class="flex items-start space-x-3">
            <input
              ...
              class="mt-1 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
            />
            <label for="asentimientoMenor" class="text-sm text-gray-700 dark:text-gray-300">
        ...
        <div *ngIf="consentForm.get('acepto')?.invalid && consentForm.get('acepto')?.touched" class="text-red-600 dark:text-red-400">
          Debes aceptar el consentimiento para continuar
        </div>

        <div *ngIf="isMenor && consentForm.get('asentimientoMenor')?.invalid && consentForm.get('asentimientoMenor')?.touched" class="text-red-600 dark:text-red-400">
