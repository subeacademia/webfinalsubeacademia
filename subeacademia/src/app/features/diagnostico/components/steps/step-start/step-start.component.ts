...
@Component({
  ...
  template: `
    <div class="text-center animate-fade-in">
      ...
      <div class="mb-6 md:mb-8">
        <div class="inline-flex items-center space-x-2 bg-blue-900/30 border border-blue-500/50 rounded-full px-4 md:px-6 py-2 md:py-3 text-blue-200 mx-4">
      ...
      <div class="mb-6 md:mb-8">
        ...
        <div class="flex flex-col md:flex-row gap-4 md:gap-6 justify-center max-w-4xl mx-auto px-4">
          ...
          <div class="flex-1 max-w-md">
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 md:p-8 border border-white/20 hover:border-blue-400/50 transition-all duration-300 hover:scale-105">
          ...
          <!-- Opción Persona -->
          <div class="flex-1 max-w-md">
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 md:p-8 border border-white/20 hover:border-green-400/50 transition-all duration-300 hover:scale-105">
              <div class="text-center">
