  ...
  template: `
    <div class="text-center animate-fade-in">
      <div class="mb-6 md:mb-8">
        ...
        <p class="text-lg md:text-xl text-slate-700 dark:text-slate-300 max-w-2xl mx-auto leading-relaxed px-4">
          {{ 'diagnostico.subtitle' | i18nTranslate }}
        </p>
      </div>
      
      <div class="mb-6 md:mb-8">
        <div class="inline-flex items-center space-x-2 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-full px-4 md:px-6 py-2 md:py-3 text-blue-700 dark:text-blue-300 shadow-sm mx-4">
      ...
      <div class="mb-6 md:mb-8">
        <h2 class="text-xl md:text-2xl font-semibold text-slate-900 dark:text-white mb-4 md:mb-6 px-4">
        ...
        <div class="flex flex-col md:flex-row gap-4 md:gap-6 justify-center max-w-4xl mx-auto px-4">
          ...
          <div class="flex-1 max-w-md">
            <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 md:p-8 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
              <div class="text-center">
                ...
                <h3 class="text-lg md:text-xl font-bold text-slate-900 dark:text-white mb-2 md:mb-3">{{ 'diagnostico.company_option' | i18nTranslate }}</h3>
                <p class="text-slate-600 dark:text-slate-400 mb-4 md:mb-6 text-xs md:text-sm leading-relaxed">
          ...
          <div class="flex-1 max-w-md">
            <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 md:p-8 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
              <div class="text-center">
                ...
                <h3 class="text-lg md:text-xl font-bold text-slate-900 dark:text-white mb-2 md:mb-3">{{ 'diagnostico.person_option' | i18nTranslate }}</h3>
                <p class="text-slate-600 dark:text-slate-400 mb-4 md:mb-6 text-xs md:text-sm leading-relaxed">
      ...
      <div class="mt-6 md:mt-8 text-slate-500 dark:text-slate-400 text-xs md:text-sm px-4">
