    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md mx-auto text-center shadow-xl">
        ...
        <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-2">
          Generando tu Diagnóstico de IA para Empresas
        </h3>
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-center justify-between text-sm text-gray-600 dark:text-gray-400">
            <span>Generando análisis estratégico</span>
            <div class="flex space-x-1">
...
export class AiProcessingLoaderComponent {
  status = input<string>('Procesando...');
}
