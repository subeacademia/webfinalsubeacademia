...
@Component({
  ...
  template: `
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" (click)="closeModal()">
      <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-md w-full mx-4" (click)="$event.stopPropagation()">
          ...
          <div class="space-y-4 mb-8">
            ...
            <label class="flex items-center space-x-3 cursor-pointer">
              ...
              <div class="flex items-center space-x-3">
                ...
                <span class="text-gray-700 dark:text-gray-300">TikTok</span>
              </div>
            </label>
          </div>
