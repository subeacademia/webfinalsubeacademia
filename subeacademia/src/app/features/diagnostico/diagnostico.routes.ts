...
export const DIAGNOSTICO_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'ares', loadComponent: () => import('./components/steps/step-ares/step-ares.component').then(m => m.StepAresComponent) },
      { path: 'ares/:phase', loadComponent: () => import('./components/steps/step-ares/step-ares.component').then(m => m.StepAresComponent) },
      { path: 'competencias', loadComponent: () => import('./components/steps/step-competencias/step-competencias.component').then(m => m.StepCompetenciasComponent) },
