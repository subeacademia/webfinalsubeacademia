...
@Component({
  ...
  template: `
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 transition-opacity duration-200" (click)="closeModal()">
      <div class="bg-[var(--panel)] border border-[var(--border)] rounded-2xl p-8 max-w-md w-full mx-4 transform transition-all duration-200 ease-out animate-in" (click)="$event.stopPropagation()" [ngClass]="{ 'scale-100 opacity-100': isOpen, 'scale-95 opacity-0': !isOpen }">
          ...
          <div class="space-y-4 mb-8">
            ...
            <label class="flex items-center space-x-3 cursor-pointer">
              ...
              <div class="flex items-center space-x-3">
                ...
                <span class="text-[var(--fg)]">Instagram</span>
              </div>
            </label>
            ...
            <label class="flex items-center space-x-3 cursor-pointer">
              ...
              <div class="flex items-center space-x-3">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-.9-.40-1.71-.95-2.27-.32-.32-.7-.49-1.13-.49-.37 0-.74.16-1.03.42-.63.69-.88 1.61-.84 2.56.05 1.42 1.2 2.69 2.58 2.76 1.68-.15 3.26-1.23 3.5-2.87.01-.54.07-1.1-.14-1.61-.25-.71-.73-1.34-1.36-1.75-.87-.6-2.03-.69-3.02-.37.01-1.48-.06-2.96-.04-4.44 2.17-.41 4.49.28 6.15 1.72 1.46 1.24 2.4 3.06 2.58 4.96.02.49.01.99-.01 1.49-.21 2.34-1.63 4.52-3.65 5.71-1.22.72-2.65 1.11-4.08 1.03-2.33-.04-4.6-1.29-5.91-3.21-.81-1.15-1.27-2.54-1.35-3.94-.03-2.91-.01-5.83-.02-8.75-.52.34-1.05.67-1.62.93-1.31.62-2.76.92-4.2.97V6.09c1.54-.17 3.12-.68 4.24-1.79 1.12-1.08 1.67-2.64 1.75-4.17z"/>
                </svg>
                <span class="text-[var(--fg)]">TikTok</span>
              </div>
            </label>
          </div>
