  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Paleta extendida de colores primarios
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
        ...
        // Colores de gradiente para efectos especiales
        gradient: {
          ...
          'teal-blue': 'linear-gradient(135deg, #a8edea 0%, #fed6e3 100%)',
      ...
      // Espaciado extendido para mejor jerarquía visual
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
        '128': '32rem',
